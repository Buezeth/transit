// app/(admin)/dashboard/settings/components/tariff-row.tsx
'use client';
      ...
      <td className="px-6 py-4">
        {isEditing ? (
          <select
            ...
            disabled={isPending}
            className="p-1.5 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 outline-none bg-white"
          >
